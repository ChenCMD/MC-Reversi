...
#集計用えんちち
    execute at @e[tag=BoardPos_201] run summon armor_stand ~ 5 ~ {Tags:["AggregateEntity_201","Entity_201"],Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,Rotation:[-90f]}
#集計スタート
