...
summon armor_stand 2065 11 17 {Rotation:[-45.0f,0f],Marker:1b,Invisible:1b,Tags:[BoardSize_201]}
...
execute at @e[tag=BoardSize_201] run fill 2064 0 16 ~1 10 ~1 orange_stained_glass
