#カーソル位置に石
    ...
    execute if score $TurnColor ReversiData_201 matches 0 run summon armor_stand ~ 38.6 ~ {ArmorItems:[{},{},{},{id:"minecraft:black_concrete",Count:1b}],Fire:32767s,Tags:[fire_000,stone_201,Entity_201],Marker:1b,Invisible:1b}
    ...
    execute if score $TurnColor ReversiData_201 matches 1 run summon armor_stand ~ 38.6 ~ {ArmorItems:[{},{},{},{id:"minecraft:white_concrete",Count:1b}],Fire:32767s,Tags:[fire_000,stone_201,Entity_201],Marker:1b,Invisible:1b}
