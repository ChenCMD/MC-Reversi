...
execute if score $TurnColor ReversiData_201 matches 0 if score $isSuccess ReversiData_201 matches 1 run particle dust 0 0 0 1 ~ 40.6 ~ 0.2 0 0.2 1 8 force
execute if score $TurnColor ReversiData_201 matches 1 if score $isSuccess ReversiData_201 matches 1 run particle dust 0.8 0.8 0.8 1 ~ 40.6 ~ 0.2 0 0.2 1 8 force