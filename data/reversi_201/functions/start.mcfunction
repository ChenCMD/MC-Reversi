...
#開始
    ...
    #初期石配置
        summon armor_stand 2065 5 17 {Rotation:[-45f],Marker:1b,Invisible:1b,Tags:[Board_201]}
        ...
        execute as @e[tag=Board_201] at @s run function reversi_201:size_set_loop
        execute at @e[tag=Board_201] run setblock ~0 5 ~0 white_concrete
        ...
        execute at @e[tag=Board_201] run setblock ~0 5 ~1 black_concrete
        ...
        execute at @e[tag=Board_201] run setblock ~1 5 ~0 black_concrete
        ...
        execute at @e[tag=Board_201] run setblock ~1 5 ~1 white_concrete
