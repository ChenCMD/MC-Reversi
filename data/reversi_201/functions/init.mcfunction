...
data modify storage reversi_201:menu Template.BaseMenu set value []
data modify storage reversi_201:menu Template.BaseMenu append value {Offset:[3.2f,1.5f],Setting:{CursorCollider:1b,TextInterpret:1b,TextSpaceWidth:0.22f},HologramID:2001,Text:['{"text":"メ","color":"white","font":"uniform"}','{"text":"ニ","color":"white","font":"uniform"}','{"text":"ュ","color":"white","font":"uniform"}','{"text":"ー","color":"white","font":"uniform"}']}
data modify storage reversi_201:menu Template.BaseMenu append value {Offset:[2.4f,1.5f],Setting:{CursorCollider:0b,TextInterpret:1b,TextSpaceWidth:0.22f},HologramID:2000,Text:['{"text":"ス","color":"green","font":"uniform"}','{"text":"キ","color":"green","font":"uniform"}','{"text":"ン","color":"green","font":"uniform"}']}
data modify storage reversi_201:menu Template.BaseMenu append value {Offset:[4.2f,1.5f],Setting:{CursorCollider:1b,TextInterpret:1b,TextSpaceWidth:0.22f},HologramID:2002,Text:['{"text":"設","color":"white","font":"uniform"}','{"text":"定","color":"white","font":"uniform"}']}

data modify storage reversi_201:menu Default.Skin set from storage reversi_201:menu Template.BaseMenu[]
...
data modify storage reversi_201:menu Default.Menu set from storage reversi_201:menu Template.BaseMenu[]
...
data modify storage reversi_201:menu Default.Setting set from storage reversi_201:menu Template.BaseMenu[]
