...
#サウンド
    execute if score $StoneBlack ReversiData_201 = $StoneWhite ReversiData_201 run playsound entity.villager.trade ambient @a[scores={playing_000=201}] ~ ~ ~ 0.5 1 1
    execute unless score $StoneBlack ReversiData_201 = $StoneWhite ReversiData_201 run playsound ui.toast.challenge_complete player @a[scores={playing_000=201}] ~ ~ ~ 0.5 1 1
#ゴミ処理
