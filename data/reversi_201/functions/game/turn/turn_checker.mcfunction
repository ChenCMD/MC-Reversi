...
#全マス埋まってなかったら続ける
    execute unless score #StoneQuantity ReversiData_201 = #StoneQuantityMAvX ReversiData_201 run summon armor_stand -19999 10 17 {Tags:[Checker_201,Entity_201],Marker:1b,Invisible:0b,Rotation:[-90.0f,0f]}
