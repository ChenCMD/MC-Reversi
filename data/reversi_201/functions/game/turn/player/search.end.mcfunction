#置けるマスがある時の処理
    ...
    #メッセージとサウンド
        ...
        execute if entity @e[tag=CursorEntity_201] if score #TurnColor ReversiData_201 matches 0 run playsound entity.experience_orb.pickup player @a[tag=Player_Black_201,scores={playing_000=201}] 2969.0 40.5 21.0 1 1.2 1
        execute if entity @e[tag=CursorEntity_201] if score #TurnColor ReversiData_201 matches 1 run playsound entity.experience_orb.pickup player @a[tag=Player_White_201,scores={playing_000=201}] 2969.0 40.5 21.0 1 1.2 1
