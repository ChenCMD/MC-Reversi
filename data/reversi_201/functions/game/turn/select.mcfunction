...
#決定時の処理
    execute as @e[tag=CursorEntity_201,nbt={HurtTime:10s},distance=..200,x=2069.0,y=40.0,z=21.0] at @s align xyz positioned ~-22063.5 10 ~0.5 run function reversi_201:game/stone/set