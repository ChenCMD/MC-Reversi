...
#実際に石を配置する
    #一か所の選出
        execute as @e[tag=Candidate_201,tag=!InactiveCandidate_201,tag=!AlreadyTestPoint_201,distance=..50,x=-19995.0,y=11.0,z=21.0,limit=1] at @s run tag @s add TestPoint_201
    #候補の無効化
        tag @e[tag=Candidate_201,tag=!InactiveCandidate_201,distance=..50,x=-19995.0,y=11.0,z=21.0] add InactiveCandidate_201
    #clone済みの盤面に石を置く
