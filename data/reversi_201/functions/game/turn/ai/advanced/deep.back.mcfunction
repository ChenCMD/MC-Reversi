...
#最良値は相手ターンの場合加算 自身ターンの場合減算
    ...
    #一つ上の盤面にまだ掘ってない候補があったら掘る 無ければ一つ上のInactiveと2つ上のInactiveTestPointを外してさらにここを実行する
        #if ((StoneQuantity >= AI-LastAlgorithm && RemainingDepth != LastDepth) || (StoneQuantity < AI-LastAlgorithm && RemainingDepth != AI-Lv))
        execute if score #StoneQuantity ReversiData_201 < #AI-LastAlgorithm ReversiData_201 unless score #RemainingDepth ReversiData_201 = $AI-Lv ReversiData_201 at @e[tag=TestPoint_201,tag=!InactiveTestPoint_201] positioned 2064 ~ 16 if entity @e[tag=Candidate_201,tag=InactiveCandidate_201,tag=!AlreadyTestPoint_201,dx=15,dy=0,dz=15] run function reversi_201:game/turn/ai/advanced/deep.another_point
        execute if score #StoneQuantity ReversiData_201 < #AI-LastAlgorithm ReversiData_201 unless score #RemainingDepth ReversiData_201 = $AI-Lv ReversiData_201 at @e[tag=TestPoint_201,tag=!InactiveTestPoint_201] positioned 2064 ~ 16 unless entity @e[tag=Candidate_201,tag=InactiveCandidate_201,tag=!AlreadyTestPoint_201,dx=15,dy=0,dz=15] run function reversi_201:game/turn/ai/advanced/deep.further_back
        execute if score #StoneQuantity ReversiData_201 >= #AI-LastAlgorithm ReversiData_201 unless score #RemainingDepth ReversiData_201 = #LastDepth ReversiData_201 at @e[tag=TestPoint_201,tag=!InactiveTestPoint_201] positioned 2064 ~ 16 if entity @e[tag=Candidate_201,tag=InactiveCandidate_201,tag=!AlreadyTestPoint_201,dx=15,dy=0,dz=15] run function reversi_201:game/turn/ai/advanced/deep.another_point
        execute if score #StoneQuantity ReversiData_201 >= #AI-LastAlgorithm ReversiData_201 unless score #RemainingDepth ReversiData_201 = #LastDepth ReversiData_201 at @e[tag=TestPoint_201,tag=!InactiveTestPoint_201] positioned 2064 ~ 16 unless entity @e[tag=Candidate_201,tag=InactiveCandidate_201,tag=!AlreadyTestPoint_201,dx=15,dy=0,dz=15] run function reversi_201:game/turn/ai/advanced/deep.further_back