...
#置ける場所が最初から一か所しかない場合処理の簡略化
    execute unless entity @e[tag=Candidate_201,scores={SortValue_201=1..},distance=..50,x=-19995.0,y=11.0,z=21.0,limit=1] run scoreboard players set #RemainingDepth ReversiData_201 0
#Lv1 処理
    execute if score #RemainingDepth ReversiData_201 matches ..0 as @e[tag=Candidate_201,distance=..50,x=-19995.0,y=11.0,z=21.0] unless score @s SortValue_201 matches 0..0 run kill @s
...
#Lv2+処理
    ...
    execute if score #RemainingDepth ReversiData_201 matches 1.. if score #StoneQuantity ReversiData_201 < #AI-LastAlgorithm ReversiData_201 as @e[tag=Candidate_201,distance=..50,x=-19995.0,y=11.0,z=21.0] unless score @s SortValue_201 matches 0..4 run kill @s
