...
execute store result score $Current SheepID_X_201 run data get entity @e[tag=temP,limit=1] Pos[0] 10
execute store result score $Current SheepID_Y_201 run data get entity @e[tag=temP,limit=1] Pos[2] 10
kill @e[tag=temP]
