...
execute if score $TurnColor ReversiData_201 matches 0 if score #isSuccess ReversiData_201 matches 1 run data modify entity @e[limit=1,type=armor_stand,tag=stone_201,y=38.6,distance=..0.05] ArmorItems[3].id set value "minecraft:black_concrete"
execute if score $TurnColor ReversiData_201 matches 0 if score #isSuccess ReversiData_201 matches 1 store result entity @e[limit=1,type=armor_stand,tag=stone_201,y=38.6,distance=..0.05] ArmorItems[3].tag.CustomModelData int 1 run scoreboard players get #CurrentSkin StoneSkin_201
...
execute if score $TurnColor ReversiData_201 matches 1 if score #isSuccess ReversiData_201 matches 1 run data modify entity @e[limit=1,type=armor_stand,tag=stone_201,y=38.6,distance=..0.05] ArmorItems[3].id set value "minecraft:white_concrete"
execute if score $TurnColor ReversiData_201 matches 1 if score #isSuccess ReversiData_201 matches 1 store result entity @e[limit=1,type=armor_stand,tag=stone_201,y=38.6,distance=..0.05] ArmorItems[3].tag.CustomModelData int 1 run scoreboard players get #CurrentSkin StoneSkin_201
