#カーソル位置に石
    ...
    execute if score $TurnColor ReversiData_201 matches 0 run summon armor_stand ~ 38.6 ~ {ArmorItems:[{},{},{},{id:"minecraft:black_concrete",Count:1b,tag:{CustomModelData:0}}],Tags:[stone_201,Entity_201],NoGravity:1b,Invisible:1b,Invulnerable:1b}
    execute if score $TurnColor ReversiData_201 matches 0 store result entity @e[limit=1,type=armor_stand,tag=stone_201,y=38.6,distance=..0.05] ArmorItems[3].tag.CustomModelData int 1 run scoreboard players get #CurrentSkin StoneSkin_201
    ...
    execute if score $TurnColor ReversiData_201 matches 1 run summon armor_stand ~ 38.6 ~ {ArmorItems:[{},{},{},{id:"minecraft:white_concrete",Count:1b,tag:{CustomModelData:0}}],Tags:[stone_201,Entity_201],NoGravity:1b,Invisible:1b,Invulnerable:1b}
    execute if score $TurnColor ReversiData_201 matches 1 store result entity @e[limit=1,type=armor_stand,tag=stone_201,y=38.6,distance=..0.05] ArmorItems[3].tag.CustomModelData int 1 run scoreboard players get #CurrentSkin StoneSkin_201
