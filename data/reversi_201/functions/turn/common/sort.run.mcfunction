...
#値の衝突を無くす
    execute at @e[tag=Candidate_201,tag=!InactiveCandidate_201] as @e[sort=random,tag=Candidate_201,tag=!InactiveCandidate_201] run function reversi_201:turn/common/sort.duplicated_shift