...
summon area_effect_cloud ~ ~35.5 ~ {Rotation:[0f,90f],Age:-2147483648,Duration:-1,WaitTime:-2147483648,Tags:["Display"],CustomNameVisible:1b,CustomName:"\"\""}
loot spawn ~ 200 ~ loot reversi_201:resolve
