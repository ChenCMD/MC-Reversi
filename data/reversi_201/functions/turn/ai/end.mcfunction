#置けるマスがない時の処理
    ...
    #0じゃない = たまたま置けない時の処理
        ...
        #次のターンにする
            ...
            execute unless entity @e[tag=Candidate_201] unless score $StoneBlack ReversiData_201 matches 0 unless score $StoneWhite ReversiData_201 matches 0 run function reversi_201:turn/check/1
