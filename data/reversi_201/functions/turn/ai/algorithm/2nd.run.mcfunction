...
execute positioned ~ ~-1 ~ run function reversi_201:stone/util/put.set

summon armor_stand 2065 ~-1 17 {Tags:[PreLastChecker_201,Entity_201],Marker:1b,Invisible:0b,Rotation:[-90.0f,0f]}

execute as @e[tag=PreLastChecker_201] at @s run function reversi_201:turn/ai/algorithm/2nd.recursive
