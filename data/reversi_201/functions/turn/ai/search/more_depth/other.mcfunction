#TestPoint吹き飛ばす
    ...
    tag @e[tag=Candidate_201,tag=TestPoint_201,tag=!InactiveTestPoint_201,dx=20,dy=0,dz=20] remove TestPoint_201
#盤面clone
...
#新しい採掘
    execute at @e[tag=TempY_201] run summon armor_stand 2065 ~-1 17 {Tags:[Checker_201,Entity_201],Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,Rotation:[-90.0f,0f]}
    execute at @e[tag=TempY_201] positioned 2064 ~ 16 run tag @e[limit=1,tag=Candidate_201,tag=InactiveCandidate_201,tag=!AlreadyTestPoint_201,dx=20,dy=0,dz=20] add TestPoint_201
