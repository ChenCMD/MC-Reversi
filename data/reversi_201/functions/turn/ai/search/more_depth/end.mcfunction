...
#CursorEntityがある = 置けるマスがある ときの処理
    ...
    #ソート
        execute if entity @e[tag=Candidate_201,tag=!InactiveCandidate_201] run function reversi_201:turn/ai/search/sort/run
    ...
    #まだ掘る処理
        ...
        #更に掘る
            execute if entity @e[tag=Candidate_201,tag=!InactiveCandidate_201] if score #RemainingDepth ReversiData_201 matches 1.. as @e[tag=Checker_201] run function reversi_201:turn/ai/search/more_depth/init