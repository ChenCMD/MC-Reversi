...
#つぎ
    ...
    execute at @e[tag=CheckEntity_201] if score #TickThroughputC ReversiData_201 matches 1.. unless block ~ ~ ~ polished_diorite_slab run function reversi_201:turn/check2
    execute at @e[tag=CheckEntity_201] if score #TickThroughputC ReversiData_201 matches ..0 unless block ~ ~ ~ polished_diorite_slab run schedule function reversi_201:turn/check2pre 1t
