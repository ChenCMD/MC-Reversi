#置けるマスがある時の処理
    ...
    #カーソル見えるように
        execute if entity @e[tag=CursorEntity_201] run schedule function reversi_201:turn/player/cursor.move 1t
#置けるマスがない時の処理
    execute unless entity @e[tag=CursorEntity_201] run function reversi_201:turn/common/cant_place
#後処理
    kill @s
