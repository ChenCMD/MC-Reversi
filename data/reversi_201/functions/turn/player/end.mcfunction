    ...
    #0じゃない = たまたま置けない時の処理
        ...
        #!連続
            ...
            #次のターンにする
                ...
                execute unless entity @e[tag=CursorEntity_201] unless score $StoneBlack ReversiData_201 matches 0 unless score $StoneWhite ReversiData_201 matches 0 unless score #SkipFlag ReversiData_201 matches 1 run schedule function reversi_201:turn/turn_checker 30t
                execute unless entity @e[tag=CursorEntity_201] unless score $StoneBlack ReversiData_201 matches 0 unless score $StoneWhite ReversiData_201 matches 0 unless score #SkipFlag ReversiData_201 matches 1 run tellraw @a {"text":"[P] SkipFlag = 1;"}
