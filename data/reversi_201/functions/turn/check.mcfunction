...
#全マス埋まってなかったら続ける
    execute unless score $StoneQuantity ReversiData_201 = $StoneQuantityMAX ReversiData_201 at @e[tag=BoardPos_201] run summon armor_stand ~ 5 ~ {Tags:["CheckEntity_201","Entity_201"],Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,Rotation:[-90f]}
